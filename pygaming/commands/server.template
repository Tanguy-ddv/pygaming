"""Use this file to create a server of an online game."""

from pygaming import GServer, CServer, Database, Files, Logger, Phase, Save

class MyGameServer(GServer):
